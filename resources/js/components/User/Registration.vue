<template>
    <input v-model="name" type="text" class="form-control mb-3 mt-3" placeholder="name" autofocus>
    ...
    <input @click="store" type="button" class="btn btn-primary" value="Register">
</template>
